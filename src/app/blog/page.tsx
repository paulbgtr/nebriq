...
import { SiteLayout } from "@/shared/components/layouts/site-layout";
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-16">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              ...
              team. Stay updated with cutting-edge developments and best
              practices.
            </p>
          </div>
          ...
          {/* Product CTA */}
          <div className="mt-20">
            <div className="bg-gradient-to-br from-primary/10 via-primary/5 to-background rounded-3xl border border-primary/20 p-8 md:p-12 text-center relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-lg text-muted-foreground mb-8 max-w-3xl mx-auto">
                  Discover how Nebriq can revolutionize your knowledge
                  management and boost your productivity. Join thousands of
                  users who have already made the switch.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link
                    href="/#features"
                    className="px-8 py-4 bg-primary hover:bg-primary/90 text-primary-foreground rounded-xl font-semibold text-lg transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl"
                  >
                    Explore Features
                  </Link>
                  <Link
                    href="/#pricing"
                    className="px-8 py-4 border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground rounded-xl font-semibold text-lg transition-all duration-300 hover:scale-105"
                  >
                    View Pricing
                  </Link>
                </div>
          ...
          <div className="mt-12 text-center">
            <div className="bg-gradient-to-r from-primary/5 via-primary/10 to-primary/5 rounded-2xl border border-primary/20 p-8 md:p-12">
              <h3 className="text-2xl md:text-3xl font-bold text-foreground mb-4">
                Stay Updated
              </h3>
              <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                Get the latest articles and insights delivered straight to your
                inbox. Join our community of developers and knowledge
                enthusiasts.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
                ...
                />
                <button className="px-6 py-3 bg-primary hover:bg-primary/90 text-primary-foreground font-medium rounded-lg transition-colors duration-300">
                  Subscribe
                </button>
              </div>
            </div>
