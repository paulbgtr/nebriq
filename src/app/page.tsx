...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {/* Theme Switcher */}
      <div className="fixed top-14 right-8 z-50">
        <ModeToggle />
      </div>
      ...
      <main className="flex-1">
        ...
        <section
          id="hero"
          className="relative min-h-[90vh] flex items-center pt-10"
          ref={heroRef}
        >
            ...
            >
              <div className="flex flex-col items-center gap-3 mb-8">
                ...
                <div className="flex items-center gap-2 text-sm text-muted-foreground">
                  <span>1. Join Waitlist</span>
                  <ArrowRight className="w-4 h-4" />
                  <span>2. Get Approved</span>
                  <ArrowRight className="w-4 h-4" />
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            >
              ...
              >
                ...
                folders, and complicated workflows. They promise organization
                but deliver complexity. We believe that capturing and developing
                your ideas shouldn&apos;t require a manual.
              </motion.p>
            ...
            <div className="grid md:grid-cols-2 gap-8 lg:gap-16">
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    understands the meaning behind your queries. Go beyond
                    simple keyword matching to discover relevant content across
                    your notes.
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Experience the power of Briq, your intelligent note
                    companion. From summarizing content and finding connections
                    to answering questions about your notes, Briq helps you get
                    more value from your knowledge base. It&apos;s like having a
                    research assistant that knows your notes inside and out.
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    knowledge network grows naturally, revealing new insights
                    and connections you never noticed before.
                  </p>
                </div>
              </motion.div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground mb-8">
                Join our early adopters and experience a simpler way to write
                and think clearly.
              </p>
              <Button
                size="lg"
